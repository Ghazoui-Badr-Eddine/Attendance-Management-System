...
<head>
    ...
    <body>
        ...
        <div class="panel panel-default pan">
            <div class="panel-heading"><p>Find Student</p></div>
  <div class="panel-body col">
        <div class="rech">
            <form action="resultat.php" method="get">
 <label>Search: </label>  <input type="text" placeholder="Enter CNE" name="CNE"  size="25"/>
        
        <input type="submit" class="btn btn-default btn " value="valider">
            </form>
